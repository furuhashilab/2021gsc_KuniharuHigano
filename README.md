# GPS Drawing を用いた文字表現手法による参加型聖地巡礼コンテンツ作成の提案 〜 サカナクション「宝島」を例に 〜
...
## 場所に価値を与えるとは
・これまでの音楽は「音」のみに価値があった(PVを除く)

・場所は消えることなく一生残り続ける

・普通の道が聖地となり歩くだけで聖地巡礼となる

・「地域資源を商 品として取引・消費する仕組みとしての観光」で　はなく「新たな文化創造につながる感性的ネット ワーク（架け　　橋）構築の一形態としての観光」(山村,2009)


# Conclusion
 * GPS Drawingは世界各地で同時複数進行で作成できるArt手法
 * 見当をつけて道を探すことが重要である
 * GPSを使えば場所と時間が記憶として残る
 * 違う曲で新しいパロディ動画を作ってもらいたい
 * GPS Drawingを使ったPVやライブ演出が出てきてほしい
